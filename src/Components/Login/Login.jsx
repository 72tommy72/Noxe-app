...
export default function Login( props ){
    ...
    return <>
        <form onSubmit={submitMyForm} action="">
            {props.message === undefined ? '' : <div className='alert alert-danger'></div>}
            <div style={{"display":'none'}} className="alert alert-success text-center"> Login Succeeded</div>
            ...
            <div className="d-flex justify-content-center align-content-center mt-5">
                <div className="w-50 mt-5">
                    ...
                    <button onClick={submitMyForm} className="btn btn-outline-info mt-4">
                        {clickedButton === true ? <div ><FontAwesomeIcon className="fa-spin" icon={faSpinner } /></div> : 'Login' }
                    </button>
                </div>
            </div>
        </form>
